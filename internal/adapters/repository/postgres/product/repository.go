...
func (r *repository) SaveNeighborFeedback(ctx context.Context, input productapp.RecordNeighborFeedbackInput) (productapp.NeighborFeedbackOutput, error) {
	var output productapp.NeighborFeedbackOutput
	...
	if err != nil {
		return productapp.NeighborFeedbackOutput{}, err
	}
